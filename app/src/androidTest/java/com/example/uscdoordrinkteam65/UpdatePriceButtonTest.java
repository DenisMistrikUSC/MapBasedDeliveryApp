...
public class UpdatePriceButtonTest {
    ...
    public void addItemButtonTest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.registerEmail),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("seller" + id + "@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction switch_ = onView(
                allOf(withId(R.id.switch1), withText("Are you a seller?"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.username),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("seller" + id + "@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction materialButton4 = onView(
                allOf(withId(R.id.updatePrice), withText("Update Item Price"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
